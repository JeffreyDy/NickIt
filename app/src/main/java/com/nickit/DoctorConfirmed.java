...
public class DoctorConfirmed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View V = inflater.inflate(R.layout.activity_doc_confirmed, container, false);
        datasource=new NickITDataSource(inflater.getContext());
        List<UserSchedule> notifs=datasource.getSchedule().getAllNotif(Integer.valueOf(DoctorActivity.getUser_id()),1);
        // Log.e("TAGG",notifs.size()+"HEHE");
        DoctorNotifView=(ListView)V.findViewById(R.id.listView3);


        DocConfirmedAdapter adapter1 = new DocConfirmedAdapter(V.getContext(),
